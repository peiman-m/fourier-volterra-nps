...
MODEL_TYPES=(
    ...
    # "convcnp-unet-linear"
    # "convcnp-fno-linear"
    # "sf-convcnp-f5-e288-linear"

    # ### frequency discretization
    # "sf-volterra-convcnp-f1-e128-l5-vr4"
    # "sf-volterra-convcnp-f2.5-e128-l5-vr4"
    # "sf-volterra-convcnp-f7.5-e128-l5-vr4"
    # "sf-volterra-convcnp-f10-e128-l5-vr4"
    # "sf-volterra-convcnp-f15-e128-l5-vr4"
    # "sf-volterra-convcnp-f20-e128-l5-vr4"

    # ### volterra low rank
    # "sf-volterra-convcnp-f5-e128-l5-vr1"
    # "sf-volterra-convcnp-f5-e128-l5-vr2"
    # "sf-volterra-convcnp-f5-e128-l5-vr6"
    # "sf-volterra-convcnp-f5-e128-l5-vr8"
    # "sf-volterra-convcnp-f5-e128-l5-vr10"

    ### capacity scaling: fixed freq_resolution=0.1, increasing max_freq
    # n_freq = int(max_freq / 0.1): 10, 25, 75, 100, 150, 200
    # "sf-volterra-convcnp-f1-e128-l5-vr4-fixedres"
    # "sf-volterra-convcnp-f2.5-e128-l5-vr4-fixedres"
    # "sf-volterra-convcnp-f7.5-e128-l5-vr4-fixedres"
    # "sf-volterra-convcnp-f10-e128-l5-vr4-fixedres"
    # "sf-volterra-convcnp-f15-e128-l5-vr4-fixedres"
    # "sf-volterra-convcnp-f20-e128-l5-vr4-fixedres"
)
