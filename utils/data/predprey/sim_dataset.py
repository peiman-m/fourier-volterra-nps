...
class PredPreySimDataset(BaseIterableDataset):
    ...
    the following stochastic differential equations (SDEs):
        ...
        dY_t = -δ·Y_t·dt + γ·X_t·Y_t·dt + σ·Y_t^ν·dW_t^(2)
    ...
    where:
        ...
        - γ (gamma): Predator growth rate from consuming prey
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            gamma_range: Range of values for predator growth rate γ.
            delta_range: Range of values for predator death rate δ.
