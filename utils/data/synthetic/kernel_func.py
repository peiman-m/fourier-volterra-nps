...
class ScaleKernel(gpytorch.kernels.ScaleKernel, RandomHyperparameterKernel):
    ...
    def sample_hyperparameters(self):
        ...
        # Sample base kernel hyperparameters. base_kernel is a
        # RandomHyperparameterKernel; cast away gpytorch's Module attribute leak.
        cast(RandomHyperparameterKernel, self.base_kernel).sample_hyperparameters()
