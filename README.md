...
# Sawtooth functions
python train.py +experiment=synthetic/default model/synthetic=sf-convcnp-f5-e288 \
    benchmark/synthetic/output_generator=sawtooth
```
...
python train.py +experiment=image/default model/image=sf-convcnp-f5-e384 benchmark/image=base-dtd
...
```bash
python train.py +experiment=kolmogorov/default model/kolmogorov=sf-convcnp-f4.5-e176
```
...
| `benchmark/era5` | `base` | — |
| `model/<bench>` | One file per architecture variant; see `ls conf/model/<bench>/` | `model/synthetic=sf-volterra-convcnp-f5-e128-l5-vr4` |
